...
$("#btn").click(function() {
    ...
    $.ajax({
        ...
        // processData: false,
        // contentType: false,
        data: `userName=${document.form.name.value}&mobile=${document.form.mob.value}&address=${document.form.province.value}|${document.form.city.value}|${document.form.area.value}|${document.form.address.value}&money=${document.form.price.value}&comm=${document.form.guest.value}&source=1&goodsid=1&des=机器吸尘器&unit=2.5&num=${document.form.num2.value}`,
        // data: $("#form").serialize(),
